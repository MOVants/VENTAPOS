...
public class CategoryModule extends StringVal {
	...
	public void CreateCategory() throws Exception {
		...
		InventoryModule();
		Thread.sleep(1000);
		driver.findElement(By.xpath("//div[@id='q-app']/div/div/main/div[3]/div/div/div/div")).click();
		Thread.sleep(1000);
		...
		{
			System.out.println("Create Category test = Passed!");
		} else {
			System.out.println("Create Category  test = Failed!");
		}
		}
	@After
